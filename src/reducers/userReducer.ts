...
export interface addressGoogleMapType {
    lat: number;
    lng: number;
    address: string;
    streetNum: string;
...
export interface AddressGoogleMapInitialStateType {
    address: addressGoogleMapType;
}

export const AddressGoogleMapInitialState: AddressGoogleMapInitialStateType = {
    address: {
        lat: 0,
        lng: 0,
        address: '',
...
export const addressGoogleMapReducer = (state = AddressGoogleMapInitialState, action: userAddressGoogleMapActionType) => {
    switch (action.type) {
