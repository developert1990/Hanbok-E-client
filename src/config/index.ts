...
export const API_BASE = process.env.NODE_ENV === 'development' ? 'http://localhost:9002' : `http://${process.env.REACT_APP_API_BASE}:9002`; //REACT_APP_API_BASE 는 EC2의 Public IPv4 DNS 값이다.
